...
def load_audio(audio_path: str, del_silence: bool = False, extension: str = 'wav') -> np.ndarray:
    """
    ...
    """
    # print('한번 알아보자:', audio_path, '이건: ', extension)
    try:
        if extension == 'pcm':
            # print('이건pcm일때')
